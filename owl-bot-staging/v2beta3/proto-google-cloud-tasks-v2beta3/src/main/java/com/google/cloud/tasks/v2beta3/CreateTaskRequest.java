...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.google.cloud.tasks.v2beta3.Task.Builder subBuilder = null;
            if (task_ != null) {
              subBuilder = task_.toBuilder();
            }
            task_ = input.readMessage(com.google.cloud.tasks.v2beta3.Task.parser(), extensionRegistry);
            if (subBuilder != null) {
   ...
   * </pre>
   *
   * <code>.google.cloud.tasks.v2beta3.Task task = 2 [(.google.api.field_behavior) = REQUIRED];</code>
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public com.google.cloud.tasks.v2beta3.CreateTaskRequest getDefaultInstanceForType() {
      return com.google.cloud.tasks.v2beta3.CreateTaskRequest.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.tasks.v2beta3.CreateTaskRequest build() {
      com.google.cloud.tasks.v2beta3.CreateTaskRequest result = buildPartial();
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.tasks.v2beta3.CreateTaskRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.tasks.v2beta3.CreateTaskRequest) e.getUnfinishedMessage();
