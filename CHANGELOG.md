...
## [3.0.0](https://github.com/googleapis/java-tasks/compare/v2.2.0...v3.0.0) (2022-05-24)
...
* add `gcf-owl-bot[bot]` to `ignoreAuthors` ([#438](https://github.com/googleapis/java-tasks/issues/438)) ([2dcf421](https://github.com/googleapis/java-tasks/commit/2dcf421900073d42bd5c7218826bfdb1e7088ec2))
...
* **deps:** adopt flatten plugin and google-cloud-shared-dependencies ([#175](https://github.com/googleapis/java-tasks/issues/175)) ([1a61a5f](https://github.com/googleapis/java-tasks/commit/1a61a5fb740a7e2cacc791896d3fe03cf92d784f))
* **generator:** update protoc to v3.15.3 ([#377](https://github.com/googleapis/java-tasks/issues/377)) ([5c71783](https://github.com/googleapis/java-tasks/commit/5c71783e654d8b0a6c09182909a3113fab786b5b))
* next release from main branch is 2.1.0 ([#553](https://github.com/googleapis/java-tasks/issues/553)) ([9fe2ec6](https://github.com/googleapis/java-tasks/commit/9fe2ec66bd2c65650de39d7b8cb9134999267613))
...
* release gapic-generator-java v2.0.0 ([#484](https://github.com/googleapis/java-tasks/issues/484)) ([c4f2381](https://github.com/googleapis/java-tasks/commit/c4f23810f38f24826dfc51ce0a0e4d4e20e55f07))
* **v2beta2:** add QueueStats message ([13b383c](https://github.com/googleapis/java-tasks/commit/13b383cce54ff09a0cffcd84f88ccd6283a18b7b))
* **v2beta2:** add tombstoning and task retention ([#365](https://github.com/googleapis/java-tasks/issues/365)) ([13b383c](https://github.com/googleapis/java-tasks/commit/13b383cce54ff09a0cffcd84f88ccd6283a18b7b))
* **v2beta3:** add QueueStats message ([13b383c](https://github.com/googleapis/java-tasks/commit/13b383cce54ff09a0cffcd84f88ccd6283a18b7b))
* **v2beta3:** add tombstoning and task retention ([13b383c](https://github.com/googleapis/java-tasks/commit/13b383cce54ff09a0cffcd84f88ccd6283a18b7b))
* **v2beta3:** add type to Queue ([#181](https://github.com/googleapis/java-tasks/issues/181)) ([f76fe21](https://github.com/googleapis/java-tasks/commit/f76fe2112909077259cc455b15479e56f96b5369))


### Bug Fixes

* Add shopt -s nullglob to dependencies script ([#467](https://github.com/googleapis/java-tasks/issues/467)) ([4285ef6](https://github.com/googleapis/java-tasks/commit/4285ef63eab332a7582fb37892f33a766b1323b4))
* **java:** java 17 dependency arguments ([#1266](https://github.com/googleapis/java-tasks/issues/1266)) ([#550](https://github.com/googleapis/java-tasks/issues/550)) ([85ed3f4](https://github.com/googleapis/java-tasks/commit/85ed3f40ad4a883aab1df4b25e15ffa8e42f19d6))
* migrate retry settings to grpc_service_config ([#174](https://github.com/googleapis/java-tasks/issues/174)) ([661fe83](https://github.com/googleapis/java-tasks/commit/661fe83ff847dad61bf90732befabf9eef9f9706))
* release scripts from issuing overlapping phases ([#410](https://github.com/googleapis/java-tasks/issues/410)) ([47b792a](https://github.com/googleapis/java-tasks/commit/47b792aa840f68e506d56aa9123464628d590bfd))
* restore GAPIC v2 retry configs ([#144](https://github.com/googleapis/java-tasks/issues/144)) ([a03b61a](https://github.com/googleapis/java-tasks/commit/a03b61ac5313f7cd926805d0f01589b506822dc9))
* Update dependencies.sh to not break on mac ([#458](https://github.com/googleapis/java-tasks/issues/458)) ([19bc4be](https://github.com/googleapis/java-tasks/commit/19bc4be2d0fc080132b3853126848e4e73c899fb))


### Documentation

* fix docstring formatting ([#566](https://github.com/googleapis/java-tasks/issues/566)) ([22496d5](https://github.com/googleapis/java-tasks/commit/22496d59c0d8460ae83dc996d009c5b9154a9eed))
* fix grammar in documentation. ([#444](https://github.com/googleapis/java-tasks/issues/444)) ([5f67b25](https://github.com/googleapis/java-tasks/commit/5f67b252adc10509a544b780840574965e3395f7))
* generate sample code in the Java microgenerator ([#351](https://github.com/googleapis/java-tasks/issues/351)) ([bc17256](https://github.com/googleapis/java-tasks/commit/bc172567b4f6443b4ba69f8718e2523757adfdd7))
...
* updates to AppEngineHttpRequest description ([13b383c](https://github.com/googleapis/java-tasks/commit/13b383cce54ff09a0cffcd84f88ccd6283a18b7b))
...
* update dependency com.google.api:api-common to v1.9.1 ([#150](https://github.com/googleapis/java-tasks/issues/150)) ([a4d0563](https://github.com/googleapis/java-tasks/commit/a4d056386ae70f243e87cfc1589ee8354cb7d711))
* update dependency com.google.api:api-common to v1.9.2 ([#157](https://github.com/googleapis/java-tasks/issues/157)) ([8e8d3c1](https://github.com/googleapis/java-tasks/commit/8e8d3c10adb4582995c6078755f678eb44e26a05))
* update dependency com.google.api.grpc:proto-google-common-protos to v1.18.0 ([#138](https://github.com/googleapis/java-tasks/issues/138)) ([2e83e36](https://github.com/googleapis/java-tasks/commit/2e83e3680d2ab008c212921d4e699890b65b87f5))
* update dependency com.google.cloud:google-cloud-core to v1.93.5 ([#151](https://github.com/googleapis/java-tasks/issues/151)) ([d27a27f](https://github.com/googleapis/java-tasks/commit/d27a27f116df1f6fa7ca41bc0cce06ba36c65935))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.10.0 ([#232](https://github.com/googleapis/java-tasks/issues/232)) ([1a99c3d](https://github.com/googleapis/java-tasks/commit/1a99c3ddfbb948e9ebbb62b3e90e7d25ebf341e6))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.10.2 ([#246](https://github.com/googleapis/java-tasks/issues/246)) ([9466e66](https://github.com/googleapis/java-tasks/commit/9466e66de588d4649825c790e5369180e6e95986))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.12.1 ([#261](https://github.com/googleapis/java-tasks/issues/261)) ([bc5725f](https://github.com/googleapis/java-tasks/commit/bc5725f1e7764e1fe7eada68cd72d0f4036af143))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.13.0 ([#270](https://github.com/googleapis/java-tasks/issues/270)) ([842092b](https://github.com/googleapis/java-tasks/commit/842092b7e9fe46a1a1e5eaf06753f2d8b516536e))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.14.1 ([#287](https://github.com/googleapis/java-tasks/issues/287)) ([1adb43a](https://github.com/googleapis/java-tasks/commit/1adb43a3a50224b176d7ecb7788ef8da6631079f))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.15.0 ([#299](https://github.com/googleapis/java-tasks/issues/299)) ([ff919b4](https://github.com/googleapis/java-tasks/commit/ff919b4e5d60526c629cf42584a6cfa774719577))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.16.0 ([#313](https://github.com/googleapis/java-tasks/issues/313)) ([fae186d](https://github.com/googleapis/java-tasks/commit/fae186d9d9e128b3733cab3335e9f6fb94738d5f))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.16.1 ([13a93fc](https://github.com/googleapis/java-tasks/commit/13a93fce2a52036769e4496dc5ff3fb7ed6a9bf9))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.17.0 ([#326](https://github.com/googleapis/java-tasks/issues/326)) ([3c25ad3](https://github.com/googleapis/java-tasks/commit/3c25ad38f0e5388427aa8be3270cc7067dddea07))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.18.0 ([#339](https://github.com/googleapis/java-tasks/issues/339)) ([1dbb707](https://github.com/googleapis/java-tasks/commit/1dbb7070e64368f208bce046147809f8ad013077))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.19.0 ([#361](https://github.com/googleapis/java-tasks/issues/361)) ([a385638](https://github.com/googleapis/java-tasks/commit/a3856385cfd835e6bf031bd606cf8ef9c0b84e04))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.20.0 ([#373](https://github.com/googleapis/java-tasks/issues/373)) ([08ca5e1](https://github.com/googleapis/java-tasks/commit/08ca5e117ba7a4274ca4e6c32bc0d0700f013a8f))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.20.1 ([#388](https://github.com/googleapis/java-tasks/issues/388)) ([4a67c54](https://github.com/googleapis/java-tasks/commit/4a67c54a75b6b87ee1dd9943508bd8d89b192645))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.21.0 ([#401](https://github.com/googleapis/java-tasks/issues/401)) ([a4d01dc](https://github.com/googleapis/java-tasks/commit/a4d01dc922a12862fec4084afd9d9241a01cb194))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.21.1 ([#412](https://github.com/googleapis/java-tasks/issues/412)) ([4b4dcd7](https://github.com/googleapis/java-tasks/commit/4b4dcd70ee906f8ea7e0bf8dc0b51f79d8cf7711))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.8.6 ([#191](https://github.com/googleapis/java-tasks/issues/191)) ([f46ed3d](https://github.com/googleapis/java-tasks/commit/f46ed3dd0f75115ffe61eb8c099d8199d3c8ec7d))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v0.9.0 ([#215](https://github.com/googleapis/java-tasks/issues/215)) ([b446cd7](https://github.com/googleapis/java-tasks/commit/b446cd7dd3e3669a17d571097fbf44da0ad0df75))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v1 ([#421](https://github.com/googleapis/java-tasks/issues/421)) ([d6f6d73](https://github.com/googleapis/java-tasks/commit/d6f6d73658aa8d4cbb793852239ae93158220fe3))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v1.1.0 ([#430](https://github.com/googleapis/java-tasks/issues/430)) ([63a2a01](https://github.com/googleapis/java-tasks/commit/63a2a014b0903c4dc877c0895b5bee798d3cbc90))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v1.2.0 ([#437](https://github.com/googleapis/java-tasks/issues/437)) ([d38ae30](https://github.com/googleapis/java-tasks/commit/d38ae30439cf91434c6b39ea3416e73d170c32a6))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v1.3.0 ([#449](https://github.com/googleapis/java-tasks/issues/449)) ([1b322aa](https://github.com/googleapis/java-tasks/commit/1b322aa1023921e06a7c5bfb7be39e6e953028cd))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v1.4.0 ([#461](https://github.com/googleapis/java-tasks/issues/461)) ([6640d57](https://github.com/googleapis/java-tasks/commit/6640d577f546217b3c58db1997034585e2243049))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2 ([#485](https://github.com/googleapis/java-tasks/issues/485)) ([7b44bae](https://github.com/googleapis/java-tasks/commit/7b44baec9f5e7b3d85a57fb2b79ac8e5089b05c4))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.0.1 ([#491](https://github.com/googleapis/java-tasks/issues/491)) ([ff0640b](https://github.com/googleapis/java-tasks/commit/ff0640b7bae7ee46ebfd6f20226413875b08362b))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.1.0 ([#500](https://github.com/googleapis/java-tasks/issues/500)) ([0c77e5f](https://github.com/googleapis/java-tasks/commit/0c77e5ffe795da9057eb095167b386e88ae310b4))
...
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.2.0 ([#508](https://github.com/googleapis/java-tasks/issues/508)) ([71af212](https://github.com/googleapis/java-tasks/commit/71af21219d5db0fd500df2a167b71d4179a7068a))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.2.1 ([#524](https://github.com/googleapis/java-tasks/issues/524)) ([726e44d](https://github.com/googleapis/java-tasks/commit/726e44dea45842e7de25155b21555c9a029c8ab8))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.3.0 ([#531](https://github.com/googleapis/java-tasks/issues/531)) ([5cc9ef5](https://github.com/googleapis/java-tasks/commit/5cc9ef5aa2277c2b3c3c5839e15d6467f1858443))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.4.0 ([#545](https://github.com/googleapis/java-tasks/issues/545)) ([512ea1f](https://github.com/googleapis/java-tasks/commit/512ea1f093962ee51df8239ac5648eabfe9f46be))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.5.0 ([#564](https://github.com/googleapis/java-tasks/issues/564)) ([6c6c9c1](https://github.com/googleapis/java-tasks/commit/6c6c9c10cc73f487f8704b2f1f2e310b3602c65a))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.5.1 ([#571](https://github.com/googleapis/java-tasks/issues/571)) ([ea06790](https://github.com/googleapis/java-tasks/commit/ea06790596e0d2e379ee77d7816a7e02282072e7))
* update dependency com.google.cloud:google-cloud-shared-dependencies to v2.6.0 ([#578](https://github.com/googleapis/java-tasks/issues/578)) ([3fb7a27](https://github.com/googleapis/java-tasks/commit/3fb7a279fa91958c821641c31424e3751aaad715))
...
* update dependency com.google.guava:guava-bom to v29 ([#119](https://github.com/googleapis/java-tasks/issues/119)) ([39d1c1c](https://github.com/googleapis/java-tasks/commit/39d1c1c626715373e00400108c96858a56ef0406))
* update dependency com.google.protobuf:protobuf-java to v3.12.0 ([#142](https://github.com/googleapis/java-tasks/issues/142)) ([4df90ac](https://github.com/googleapis/java-tasks/commit/4df90acf9e17654318a0f8d7439e0d867ea317e5))
* update dependency com.google.protobuf:protobuf-java to v3.12.2 ([#148](https://github.com/googleapis/java-tasks/issues/148)) ([c8062c6](https://github.com/googleapis/java-tasks/commit/c8062c60cfa1ee810188703641c66c359c65c437))
* update dependency io.grpc:grpc-bom to v1.29.0 ([#131](https://github.com/googleapis/java-tasks/issues/131)) ([ea89037](https://github.com/googleapis/java-tasks/commit/ea8903701b007e2ceeb525ccf26c5992c8f18f79))
* update dependency io.grpc:grpc-bom to v1.30.0 ([#161](https://github.com/googleapis/java-tasks/issues/161)) ([d374bc3](https://github.com/googleapis/java-tasks/commit/d374bc3fa4c3a9d0085b344245ca845c9a8c2cd0))
...
* update dependency org.threeten:threetenbp to v1.4.4 ([#133](https://github.com/googleapis/java-tasks/issues/133)) ([cc0e466](https://github.com/googleapis/java-tasks/commit/cc0e46693f44f2d7c6b9ce22a7ec2d0a84b6c8f7))
