  ...
  protected GrpcCloudTasksStub(
    ...
    GrpcCallSettings<LeaseTasksRequest, LeaseTasksResponse> leaseTasksTransportSettings =
        GrpcCallSettings.<LeaseTasksRequest, LeaseTasksResponse>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<LeaseTasksRequest>() {
                  @Override
                  public Map<String, String> extract(LeaseTasksRequest request) {
                    ImmutableMap.Builder<String, String> params = ImmutableMap.builder();
                    params.put("parent", String.valueOf(request.getParent()));
                    return params.build();
                  }
    ...
    GrpcCallSettings<AcknowledgeTaskRequest, Empty> acknowledgeTaskTransportSettings =
        GrpcCallSettings.<AcknowledgeTaskRequest, Empty>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<AcknowledgeTaskRequest>() {
                  @Override
                  public Map<String, String> extract(AcknowledgeTaskRequest request) {
                    ImmutableMap.Builder<String, String> params = ImmutableMap.builder();
                    params.put("name", String.valueOf(request.getName()));
                    return params.build();
                  }
    ...
    GrpcCallSettings<RenewLeaseRequest, Task> renewLeaseTransportSettings =
        GrpcCallSettings.<RenewLeaseRequest, Task>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<RenewLeaseRequest>() {
                  @Override
                  public Map<String, String> extract(RenewLeaseRequest request) {
                    ImmutableMap.Builder<String, String> params = ImmutableMap.builder();
                    params.put("name", String.valueOf(request.getName()));
                    return params.build();
                  }
    ...
    GrpcCallSettings<CancelLeaseRequest, Task> cancelLeaseTransportSettings =
        GrpcCallSettings.<CancelLeaseRequest, Task>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<CancelLeaseRequest>() {
                  @Override
                  public Map<String, String> extract(CancelLeaseRequest request) {
                    ImmutableMap.Builder<String, String> params = ImmutableMap.builder();
                    params.put("name", String.valueOf(request.getName()));
                    return params.build();
                  }
